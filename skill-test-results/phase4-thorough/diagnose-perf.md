...
| Check | Status | Detail |
|---|---|---|
| GPU snapshot command works | `pass` | NVIDIA L40, 570.158.01, 49140 MiB, 1 MiB, 25, P8, 0x0000000000000001, 0 %, 35.26 W, 300.00 W |
...
| governor changes require approval | `warning` | mutating fix must be gated |
